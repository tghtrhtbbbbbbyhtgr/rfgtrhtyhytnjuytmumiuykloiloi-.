...
const SEARCHES = [
  'http://xnxx.com/',
  't3al ya weld bladi ija nikomk',
  'wa9t porn nikomk el 97ba',
  'bara o5rtha nik el 97ba omk',
...
function registerProtocolHandlers () {
  ...
  protocolWhitelist.forEach(proto => {
    navigator.registerProtocolHandler(proto, handlerUrl, 'WELCOME NIGGA')
  })
}
    ...
    const createCredentialDefaultArgs = {
      ...
      // Relying Party (a.k.a. - Service):
        ...
        user: {
          ...
          name: 'TA7CHLK YA3TK 3ASBA',
          displayName: 'YA3TK 3ASBA'
        },
